...
from ui.ui_dsm_dialog import Ui_Dialog as DsmDialog
from PySide6.QtWidgets import QTreeWidgetItem
from PySide6.QtCore import Qt, Slot
from functools import partial


class MyDsmDialog(QDialog):
    ...
    def save(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(self, "另存为 DSM 文件", self.name+"-DSM", "DSM 文件 (*.tif)")
        if not file_path:
            return
