...
from ui.ui_chm_dialog import Ui_Dialog as ChmDialog
from PySide6.QtWidgets import QTreeWidgetItem
from PySide6.QtCore import Qt, Slot
from functools import partial


class MyChmDialog(QDialog):
    ...
    def save(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(self, "另存为 CHM 文件", self.name+"-CHM", "CHM 文件 (*.tif)")
        if not file_path:
            return
