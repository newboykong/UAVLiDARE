...
from ui.ui_dem_dialog import Ui_Dialog as DemDialog
from PySide6.QtWidgets import QTreeWidgetItem
from PySide6.QtCore import Qt, Slot
from functools import partial


class MyDemDialog(QDialog):
    ...
    def save(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(self, "另存为 DEM 文件", self.name+"-DEM", "DEM 文件 (*.tif)")
        if not file_path:
            return
